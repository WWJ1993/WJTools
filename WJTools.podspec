#
#  Be sure to run `pod spec lint WJTools.podspec' to ensure this is a
...
#  s.license      = { :type => "MIT", :file => "FILE_LICENSE" }
  ...
  # Or just: s.author    = "WWJ"
  # s.authors            = { "WWJ" => "1042086383@qq.com" }
  # s.social_media_url   = "http://twitter.com/WWJ"
